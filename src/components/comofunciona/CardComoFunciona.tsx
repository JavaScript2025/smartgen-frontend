import { BuildingOfficeIcon, DeviceMobileIcon, HandshakeIcon } from "@phosphor-icons/react";
        ...
        <div className="container mx-auto">
          <div className="px-8 py-8 lg:py-11">
            ...
            <div className="mb-4 mt-6 grid grid-cols-1 gap-4 md:mb-6 md:grid-cols-3 md:gap-6">
              ...
              <div className="flex flex-col rounded-2xl bg-blue-200 p-4">
                <div className="flex flex-col gap-4">
                  ...
                  <h3>02. Colaboradores escolhem</h3>
                  <p>
            ...
            <div className="mx-auto flex max-w-md flex-col gap-5 md:flex-row bg-blue-500 rounded-[42px] text-white">
              <a
                className="rounded-[42px] inline-flex items-center justify-center py-4 px-8 hover:text-neutral-90 text-base transition bg-primary-40 text-neutral-90 hover:bg-blue-600 w-full"
                target="_self"
                href="/br/corporativo/"
              >
                Entre em contato!
